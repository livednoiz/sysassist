...
| `plesk_backup/`                                                                                                                                   | Enthält: **`plesk_backup.sh`**                                                                                                                                                                        |
| Führt ein strukturiertes Plesk-Backup (inkl. Datenbanken & Einstellungen) durch – verwendbar vor Migrationen oder als manuelles On-Demand-Backup. |                                                                                                                                                                                                       |
